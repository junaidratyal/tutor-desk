    ...
    <main style={{ minHeight: "100vh", fontFamily: "'Plus Jakarta Sans', sans-serif", background: "#FAFBFF" }}>
      ...
      <nav style={{ padding: "18px 40px", display: "flex", justifyContent: "space-between", alignItems: "center", background: "rgba(255,255,255,0.8)", backdropFilter: "blur(12px)", borderBottom: "1px solid #E2E8F0", position: "sticky", top: 0, zIndex: 100 }}>
        ...
        <div style={{ display: "flex", gap: 10 }}>
          ...
          <Link href="/signup" style={{ padding: "9px 20px", borderRadius: 8, background: "linear-gradient(135deg, #4F46E5, #818CF8)", color: "white", fontWeight: 600, textDecoration: "none", fontSize: 14, boxShadow: "0 4px 12px rgba(79,70,229,0.3)" }}>Sign Up Free</Link>
        </div>
      </nav>
      ...
      <section style={{ textAlign: "center", padding: "90px 20px 70px", background: "linear-gradient(180deg, #EEF2FF 0%, #FAFBFF 100%)" }}>
        ...
        <p style={{ fontSize: 18, color: "#64748B", maxWidth: 520, margin: "0 auto 40px", lineHeight: 1.7 }}>
          Pakistan ka tutor management tool. Students, fees, attendance, schedule — sab ek jagah. Bilkul free.
        </p>
        ...
        <p style={{ marginTop: 18, color: "#94A3B8", fontSize: 13 }}>Koi credit card nahi • Koi payment nahi • Bilkul free</p>
      ...
      <section id="features" style={{ padding: "80px 20px", maxWidth: 1100, margin: "0 auto" }}>
        <div style={{ textAlign: "center", marginBottom: 56 }}>
          ...
          <h2 style={{ fontSize: 38, fontWeight: 800, color: "#0F172A", letterSpacing: "-0.02em" }}>Sab kuch ek jagah</h2>
          <p style={{ color: "#64748B", marginTop: 12, fontSize: 16 }}>Koi extra app nahi — sab kuch Tutor Desk mein</p>
        </div>
        <div className="features-grid" style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 22 }}>
          {[
            { icon: "👨‍🎓", title: "Student Management", desc: "Har student ki complete profile — naam, parent contact, subject, fees. Sab organized ek jagah." },
            { icon: "💰", title: "Fee Tracking", desc: "Kaun ne diya, kaun ne nahi — ek nazar mein. Monthly fee status bilkul clear." },
            { icon: "✅", title: "Attendance Tracker", desc: "Rozana attendance mark karo. Present, Absent, Leave — ek click mein. Monthly report bhi milegi." },
            ...
            { icon: "📄", title: "Monthly Reports", desc: "Professional PDF reports generate karo — parents ko share karo ya apne paas rakho." },
          ].map((f, i) => (
      ...
      {/* CTA */}
      <section id="about" style={{ padding: "80px 20px", background: "linear-gradient(135deg, #4F46E5, #6366F1)" }}>
        <div style={{ maxWidth: 600, margin: "0 auto", textAlign: "center" }}>
          <h2 style={{ fontSize: 36, fontWeight: 800, color: "white", marginBottom: 16, letterSpacing: "-0.02em" }}>
            Abhi shuru karo — Free hai! 🚀
          </h2>
          <p style={{ color: "rgba(255,255,255,0.8)", fontSize: 16, marginBottom: 36, lineHeight: 1.7 }}>
            Pakistan ke tutors ke liye banaya gaya — simple, fast, aur bilkul free.
          </p>
          <Link href="/signup" style={{ display: "inline-block", padding: "16px 40px", background: "white", color: "#4F46E5", borderRadius: 12, fontWeight: 700, fontSize: 16, textDecoration: "none", boxShadow: "0 8px 24px rgba(0,0,0,0.15)" }}>
            Sign Up Karo — Bilkul Free →
          </Link>
        </div>
      </section>
