        ...
        <div style={{ maxWidth: 560, width: "100%" }}>
          <div style={{ textAlign: "center", marginBottom: 48 }}>
            ...
            <p style={{ color: "#64748B", fontSize: 15, lineHeight: 1.7 }}>
              Apni academy banao ya kisi academy mein join karo. Multiple tutors ek saath manage karo!
            </p>
          </div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 20 }}>
            ...
            <Link href="/academy/create" style={{ textDecoration: "none" }}>
              <div style={{ background: "white", borderRadius: 20, padding: "32px 24px", border: "2px solid #E2E8F0", textAlign: "center", cursor: "pointer", transition: "all 0.2s", boxShadow: "0 4px 16px rgba(0,0,0,0.06)" }}
                ...
                <p style={{ color: "#64748B", fontSize: 13, lineHeight: 1.6, marginBottom: 20 }}>
                  Nai academy create karo, tutors ko invite karo aur sab ka data ek jagah manage karo
                </p>
            ...
            <Link href="/academy/join" style={{ textDecoration: "none" }}>
              <div style={{ background: "white", borderRadius: 20, padding: "32px 24px", border: "2px solid #E2E8F0", textAlign: "center", cursor: "pointer", transition: "all 0.2s", boxShadow: "0 4px 16px rgba(0,0,0,0.06)" }}
                ...
                <p style={{ color: "#64748B", fontSize: 13, lineHeight: 1.6, marginBottom: 20 }}>
                  Admin ne jo invite code diya hai use karke apni academy mein join karo
                </p>
